...
![Diagrama de Flujo](TPI/Aplicacion/diagrama.png)
...
### 🧭 Menú Principal
![Menú Principal](TPI/Aplicacion/menu_principal.jpg)

### 1. Buscar País
Permite buscar un país por su nombre exacto o parcial.
*(Ejemplo: Buscar "arg" encuentra "Argentina").*

![Ejemplo de Búsqueda](TPI/Aplicacion/busqueda.jpg)
...
![Ejemplo de Filtro](TPI/Aplicacion/filtro.jpg)
...
![Ejemplo de Estadísticas](TPI/Aplicacion/estadisticas.jpg)
